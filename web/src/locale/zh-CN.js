export default {
	...
	"OVERVIEW.GENERATEFISH": "生成钓鱼项目",
	"OVERVIEW.OPERATION_CONFIRM": "确定要{0}该设备吗？",
	"OVERVIEW.OPERATION_SUCCESS": "操作已执行",

	"OVERVIEW.DATE": "日期",
	"OVERVIEW.SOURCE_IP": "来源IP",
	"OVERVIEW.RESULT": "结果",
	"OVERVIEW.VIEW": "查看",

	"OVERVIEW.OPERATION_RECORD": "记录",
	"OVERVIEW.OPERATION_CODE": "利用代码",
	"EXPLORER.STOP": "停用",
	"EXPLORER.START": "启用",
	...
	"GENERATOR.FISH_NAME": "项目名称",
	"GENERATOR.FISH_TASK_NAME": "项目名称",
	"GENERATOR.FISH_TASK_DATA": "项目备注",
	"GENERATOR.FISH_TASK_STATUS": "项目状态",
	"GENERATOR.FISH_TASK_ID": "项目ID",
	"GENERATOR.FISH_TASK_URL": "钓鱼链接",
	"GENERATOR.FISH_TASK_FILE": "钓鱼文件",
